...
public class HelpRequestControllerTests extends ControllerTestCase{
    ...
    public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
            ...
            HelpRequest helpRequest = HelpRequest.builder()
                            .requesterEmail("hiyori@azarashiparadise.org")
                            .teamId("6")
                            .tableOrBreakoutRoom("3")
                            .requestTime(ldt)
                            .explanation("azarashi!")
                            .solved(true)
                            .build();
    ...
    public void logged_in_user_can_get_all_helprequests() throws Exception {
            ...
            HelpRequest helpRequest2 =HelpRequest.builder()
                            .requesterEmail("kyoro@azarashiparadise.org")
                            .teamId("5")
                            .tableOrBreakoutRoom("3")
                            .requestTime(ldt2)
                            .explanation("azarashi!")
        ...
        public void an_admin_user_can_post_a_new_helprequest() throws Exception {
            ...
            MvcResult response = mockMvc.perform(
                            post("/api/helprequest/post?requesterEmail=hiyori@azarashiparadise.org&teamId=6&tableOrBreakoutRoom=3&requestTime=2022-01-03T00:00:00&explanation=azarashi!&solved=true")
                                            .with(csrf()))
                            .andExpect(status().isOk()).andReturn();
