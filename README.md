...
|-----------------------------|--------------|---------------|
| `UCSBDiningCommonsMenuItem` | Edwin        | Edwin-Yee     |
| `UCSBOrganization`          | Cindy        | clin947       |
| `RecommendationRequest`     | Ryan         | ryan-he-8     |
| `MenuItemReview`            | Andrew       | andrewyu6581  |
| `HelpRequest`               | Mia          | mier2         |
| `Articles`                  | Mia          | mier2         |
